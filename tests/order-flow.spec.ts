...
test("As a user, I should be able to create an order, complete the checkout process, and track the order", async ({ pageManager }) => {
  ...
  await pageManager.getContactPage().trackOrder(orderID, process.env.EMAIL_ADDRESS || "");
